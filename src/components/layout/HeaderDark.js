                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <Link to="/symposium/" onClick={this.closeMenu}>Publications</Link>
                      </li>
                      <li>
                        <Link to="/curriculum/" onClick={this.closeMenu}>Curriculum</Link>
                      </li>
                    </ul>
                    {!hideSignin &&
                      <ul
                      ...
                      >
                        <ButtonGroup>
                          <Button tag="a" color="primary" href="https://forms.gle/wCSb1F8qg4Zrgj1RA" wideMobile>
                            Apply
                          </Button>
                        </ButtonGroup>
                      </ul>}
