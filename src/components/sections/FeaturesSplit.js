...
class FeaturesSplit extends React.Component {
  ...
  render() {
    ...
    const sectionHeader = {
      ...
      paragraph: "We're committed to cultivating intellectual rigor, problem-solving proficiency, and advanced coding competencies. At BLAST Academy, students delve into the realm of competitive programming, preparing to excel in USACO competitions and beyond."
    };
              ...
              <div className="split-item">
                <div className="split-item-content center-content-mobile">
                  <h3 className="mt-0 mb-16 reveal-from-bottom" data-reveal-container=".split-item">
                    BLAST AI Bootcamp: Intro to Machine Learning
                  </h3>
                  ...
                  <p className="m-0 reveal-from-bottom" data-reveal-delay="100" data-reveal-container=".split-item">
                    Our course is a synthesis of algorithmic theory, data structures, and practical applications in competitive programming. Under the mentorship of our experienced USACO coaches, students are engaged in a rigorous test of problem-solving, concluding with a mock USACO competition. Our goal is more than teaching you to code – it's to develop the analytical brain required to thrive in competitive environments.
                  </p>
                </div>
                <div className={
                  classNames(
